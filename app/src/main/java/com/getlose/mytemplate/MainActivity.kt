...
class MainActivity : AppCompatActivity() {
    ...
    val Functions = listOf<String>("Content Provider & 危險權限","資料儲存 Room","網路連線與 JSON 資料解析實務","Camera3","Camera4","Camera5","Camera6","Camera7","Camera8","Camera9","Camera10","Camera11")
